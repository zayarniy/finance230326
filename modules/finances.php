...
<body>
            ...
            <?php foreach ($transactions as $t): ?>
                <div class="transaction-card" data-id="<?php echo $t['id']; ?>" data-type="<?php echo $t['type']; ?>"
                    ...
                    <div class="transaction-header">
                        ...
                        <span
                            class="transaction-type <?php echo $t['type']; ?>"><?php echo $t['type'] == 'income' ? 'Доход' : 'Расход'; ?></span>
                    </div>
                    ...
                    <?php if (!empty($t['description'])): ?>
                        <div class="small text-muted mt-2">📝 <?php echo htmlspecialchars(substr($t['description'], 0, 50)); ?>
                        </div>
                    <?php endif; ?>
                </div>
            <?php endforeach; ?>
    ...
    <div class="mobile-nav">
        <div class="row g-0">
            ...
            <div class="col-3">
                <a href="finances.php" class="nav-item d-block text-decoration-none">
                    <i class="bi bi-calculator"></i>
                    <span>Финансы</span>
                </a>
            </div>
            <div class="col-3">
                <a href="statistics.php" class="nav-item d-block text-decoration-none">
            ...
            <div class="modal-content">
                ...
                <form method="POST" id="transactionForm">
                    <div class="modal-body">
                        ...
                        <input type="text" name="tags_text" id="tagsInput" class="form-control"
                            placeholder="Метки (через ;)">
                        <button type="button" class="btn btn-outline-secondary mt-2 w-100" id="selectTagsBtn">Выбрать
                            метки</button>
                    </div>
                    <div class="modal-footer">
