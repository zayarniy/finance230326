...
<body>
    ...
    <div class="form-card">
        ...
        <form method="POST" action="">
            ...
            <div class="mb-3">
                ...
                <input type="password" name="current_password" class="form-control" placeholder="Введите для смены пароля">
            </div>
    ...
    <div class="mobile-nav">
        <div class="row g-0">
            ...
            <div class="col-3"><a href="profile.php" class="nav-item active"><i class="bi bi-person-fill"></i><span>Профиль</span></a></div>
        </div>
    </div>
