...
<body>
    <div class="mobile-header">
        ...
        <div class="small">Управление аккаунтом</div>
    </div>

    <?php if ($message): ?>
        <div class="alert alert-success mx-3 mb-3 rounded-pill"><?php echo $message; ?></div>
    <?php endif; ?>
    ...
    <!-- Добавьте этот блок после profile-card -->
    <div class="form-card">
        <div class="fw-semibold mb-3"><i class="bi bi-grid"></i> Управление справочниками</div>
    ...
    <div class="form-card">
        <form method="POST">
            ...
            <button type="submit" class="btn btn-primary w-100 rounded-pill">Сохранить изменения</button>
        </form>
    </div>
